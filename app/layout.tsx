...
export const metadata: Metadata = {
  title: "One Shot Idea - Creative Experiments",
  description: "A collection of creative web experiments including glass masonry galleries, 3D models, and simulation patterns",
  icons: {
